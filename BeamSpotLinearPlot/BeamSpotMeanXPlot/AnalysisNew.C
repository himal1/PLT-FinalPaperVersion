...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TGraphErrors *gr4 = new TGraphErrors(i, gFill, gmeanY,gdxy, gmeanErr);
   TGraphErrors *gr5 = new TGraphErrors(hi, gFill1, gmeanY1,gdxy1, gmeanYErr1);
   TGraphErrors *gr6 = new TGraphErrors(him, gFill2, gmeanY2,gdxy2, gmeanYErr2);
   TGraphErrors *gr7 = new TGraphErrors(hima, gFill3, gmeanY3,gdxy3, gmeanYErr3);
   //mean plot for X
   TGraphErrors *gr = new TGraphErrors(i, gFill, gmean,gdxy, gmeanErr);
   TGraphErrors *gr1 = new TGraphErrors(hi, gFill1, gmeanX1,gdxy1, gmeanXErr1);
   TGraphErrors *gr2 = new TGraphErrors(him, gFill2, gmeanX2,gdxy2, gmeanXErr2);
   TGraphErrors *gr3 = new TGraphErrors(hima, gFill3, gmeanX3,gdxy3, gmeanXErr3);
   ...
   gr->GetYaxis()->SetTitle("Beamspot x|_{z=0} [cm]");//2D
